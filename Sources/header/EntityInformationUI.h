...
private:
	...
	// エンティティの名前
	const Vector2 _NAME_POS = Vector2(-0.6f, 0.05f);
	// エンティティのID
	...
	const Vector2 _TYPE_INFORMATION_POS = Vector2(0.5f, -0.8f);
	const Vector2 _TYPE_POS = Vector2(0.5f, -0.6f);
	...
	const Vector2 _ENERGY_INFORMATION_POS = Vector2(0.45f, -0.3f);
	const std::string _ENERGY_INFORMATION_TEXT = "エネルギー";
	const Vector2 _ENERGY_POS = Vector2(0.5f, -0.1f);
