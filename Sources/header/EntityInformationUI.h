...
public:
	...
	void SetFontSize(int mainItemSize, int subItemSize);
...
private:
	...
	const Vector2 _LOCK_TEXT_POS = Vector2(0, 0);
	...
	// エンティティの名前
	const Vector2 _NAME_POS = Vector2(-0.5f, 0.05f);
	// エンティティのID
	const Vector2 _ID_POS = Vector2(-0.4f, 0.2f);
	// 危険度
	const Vector2 _HAZARD_LEVEL_POS = Vector2(0.3f, 0.2f);
	// 属性
	...
	const Vector2 _OPERATION_INFORMATION_POS = Vector2(0.0f, 0.35f);
	const std::string _OPERATION_INFORMATION_TEXT = "作業結果";
	// 良好な作業状態
	const Vector2 _GOOD_OPERATION_INFORMATION_POS = Vector2(-0.5f, 0.5f);
	const std::string _GOOD_OPERATION_INFORMATION_TEXT = "良い";
	// 良好な作業状態のテキスト
	const Vector2 _GOOD_OPERATION_POS = Vector2(0.3f, 0.5f);
	// 通常の作業状態
	const Vector2 _NORMAL_OPERATION_INFORMATION_POS = Vector2(-0.5f, 0.65f);
	const std::string _NORMAL_OPERATION_INFORMATION_TEXT = "普通";
	// 通常の作業状態のテキスト
	const Vector2 _NORMAL_OPERATION_POS = Vector2(0.3f, 0.65f);
	// 悪い作業状態
	const Vector2 _BAD_OPERATION_INFORMATION_POS = Vector2(-0.5f, 0.8f);
	const std::string _BAD_OPERATION_INFORMATION_TEXT = "悪い";
	// 悪い作業状態のテキスト
	const Vector2 _BAD_OPERATION_POS = Vector2(0.3f, 0.8f);
};
