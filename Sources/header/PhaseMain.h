...
private:
	...
	std::vector<std::vector<std::vector<int>>> _stageData =
	{
		...
		},
		{
			...
			{3, 4, 0, 0, 0, 4, 3, 5, 0, 0, 0, 5, 3},
			{3, 0, 0, 4, 0, 0, 3, 0, 0, 5, 0, 0, 3},
		...
		},
		{
			...
			{3, 4, 0, 0, 0, 4, 3, 5, 0, 0, 0, 5, 3},
			{1, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 1},
			{3, 6, 0, 0, 0, 6, 3, 0, 0, 0, 0, 0, 0},
			{3, 0, 0, 6, 0, 0, 3, 0, 0, 0, 0, 0, 0},
		...
		},
		{
			...
			{3, 4, 0, 0, 0, 4, 3, 5, 0, 0, 0, 5, 3},
			{1, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 1},
			{3, 6, 0, 0, 0, 6, 3, 7, 0, 0, 0, 7, 3},
			{3, 0, 0, 6, 0, 0, 3, 0, 0, 7, 0, 0, 3},
			{1, 2, 2, 1, 2, 2, 1, 2, 2, 1, 2, 2, 1},
			{3, 0, 0, 6, 0, 0, 3, 0, 0, 7, 0, 0, 3},
			{3, 6, 0, 0, 0, 6, 3, 7, 0, 0, 0, 7, 3},
			{1, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 1},
