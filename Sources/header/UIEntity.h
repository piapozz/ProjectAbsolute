...
private:
	...
	// 武器情報
	const Vector2 _WEAPON_POS = Vector2(0.5f, 0.1f);
	const Vector2 _WEAPON_SCALE = Vector2(0.15f, 0.45f);
	// 防具情報
	const Vector2 _SUIT_POS = Vector2(0.8f, 0.1f);
	const Vector2 _SUIT_SCALE = Vector2(0.15f, 0.45f);
	// 作業回数
	const Vector2 _OPERATION_COUNT_TEXT_POS = Vector2(0.4f, 0.75f);
